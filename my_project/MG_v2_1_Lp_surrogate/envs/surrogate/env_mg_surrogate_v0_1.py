...
# from callbacks import EpisodeReturnCallback

from envs.surrogate.user_response_fitting_v0_1 import SurrogateUser
surrogate_user = SurrogateUser(save_dir="my_project/RA_obs/user_response_model_v1")
...
User Response Model:
    - user_response_fitting_v1 (Complaint-based, probabilistic inference)

Key Changes:
    - reset randomness logic
    - init param modification
"""
...
#NOTE - 记录历史数据，用于观测补全
        ...
        if self.is_record:
            info.update ({
                ...
                # "obs": (self.obs).tolist(),
                "reward": reward,
                "sat_i":sat_i_t.tolist(), # type: ignore
