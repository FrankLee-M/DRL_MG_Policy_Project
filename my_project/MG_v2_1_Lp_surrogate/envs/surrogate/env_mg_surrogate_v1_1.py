...
from envs.surrogate.user_response_fitting_v1_1 import SurrogateUser
surrogate_user = SurrogateUser(save_dir="my_project/RA_obs/user_response_model_v1_1")
...
Major Changes:
- [BREAKING] - is_user_dynamic default True


User Response Model:
    - user_response_fitting_v1_1 (Complaint-cost-based)
"""
...
#ANCHOR - 【修改】default ： is_user_dynamic:bool = True
    def __init__(self,
...
if __name__ == "__main__":
    ...
    import argparse
    import numpy as np
    env = MgSurrogateEnv(is_user_dynamic=True,train_mode=True) 
